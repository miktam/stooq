...
import static com.tools.Tool.p_s;
...
public class Ticker {
    ...
    public void taRSI() {
        ...
        logger.trace("avgGain:" + p_s(avgGain) + ", avgLoss:" + p_s(avgLoss) + ", RS:" + p_s(RS) + ", RSI:" + p_s(RSI) + " for " + t.date.toString(Tool.dm()) + ", close =" + t.close);
        ...
        while (nextDays.hasNext()) {
            ...
            RSI = 100 - (100 / (1 + RS));
            entry.setRSI(RSI);
            logger.trace("avgGain:" + p_s(previousAvgGain) + ", avgLoss:" + p_s(previousAvgLoss) + ", RS:" + p_s(RS) + ", RSI:" + p_s(RSI) + " for " + entry.date.toString(Tool.dm()) + ", close =" + entry.close);
        }
    }
    ...
    public void taAD(int days) {
        ...
        for (EntryDayTicker e : lastEdt) {
            ...
            logger.info(e.date.toString(Tool.d()) + ":" + e.getAD() + " " + Tool.p_s(e.close));
        }
    }
    ...
    public void taSTS() {
        ...
        while (it.hasNext()) {
            ...
            logger.info(next.date.toString(Tool.d()) + " max = " + Tool.p_s(max) + ", min = " + Tool.p_s(min));
